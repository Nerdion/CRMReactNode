...
class JoinOrCreateOrganization extends Component {
    ...
    onPressJoinOrg = async (event) => {
        ...
        try {
            ...
            this.setState({ title: "Error", message: e.toString(), Alert_open_close: true, isClicked: false });
    ...
    createNewOrganization = async (event) => {
        ...
        try {
            ...
            this.setState({ title: "Error", message: err.toString(), Alert_open_close: true, isClicked: false });
        }
    }
    ...
    render() {
        let { ifJoinOrg, orgName, orgSearch, orgNameObj, title, message, Alert_open_close, alertColor, isClicked } = this.state;
