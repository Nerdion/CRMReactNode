...
class CreateTaskTest extends React.Component {
    ...
    onClickEditEditor = () => {
        this.setState((prevState) => ({ enableEditor: !prevState.enableEditor }))
    }
                        ...
                        <Col className="" xs="12" md="6" lg="8" xl="8">
                            <Form>
                                <FormGroup>
                                    ...
                                    <Input type="text" className="txt-lt-dark" name="TopicName" id="Topic" placeholder="with a placeholder" />
                                </FormGroup>
                            </Form>
                        </Col>
                            ...
                            <Col>
                                <Form>
                                    <FormGroup>
                                        ...
                                        <Input type="text" className="txt-lt-dark" name="StepTitle" id="StepTitle" placeholder="Step Title" />
                                    </FormGroup>
                                </Form>
                            </Col>
                            <div>
                                ...
                                <Row className="d-flex align-items-center justify-content-center">
                                    <Col className="text-center p-1" xs="12" sm="12" lg="6" xl="6">
                                        <Button
                                            ...
                                            className="wd-150"
                                            startIcon={<Edit />}
                                            onClick={this.onClickEditEditor}
                                        >
                                            Edit
                                        </Button>
                                    </Col>
